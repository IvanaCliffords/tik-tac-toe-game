const Board = () => {
    ...
    const turn = ["Player O", "Player X"];
    const playerTurn = player === 1 ? [turn[1]] : [turn[0]];
    ...
    return (
        <div className="game-board">
            ...
            <div id="info">
                <h1 id='turn' class='info-h1'>Next Play: {playerTurn} </h1>
                <h1 class='info-h1'>{status}</h1>
            </div>
        </div>
    );
};
...
const Square = ({ takeTurn, id }) => {
    ...
    const className = tik === 1 ? 'white' : 'black';
    ...
    return (
        ...
        >
            ...
            <h1 className={className}>{mark[tik]}</h1>
        </button>
    );
};
